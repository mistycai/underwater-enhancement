...
try:
    ...
    from metrics.contrast_gain import contrast_gain
    from metrics.colorfulness import colorfulness
    from metrics.avg_gradient import avg_gradient
    METRICS_AVAILABLE = True
except ImportError:
    pass  # Metrics will be skipped
...
def process_single_image(
    ...
    # Evaluate metrics
    metrics_list = []
    if evaluate and METRICS_AVAILABLE:
        if verbose:
